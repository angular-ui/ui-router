...
var $resolve = {
    ...
    * ### Not bundled by default
    ...
    resolve: function (invocables, locals, parent) {
        ...
        var parentNode = new ui_router_core_1.PathNode(new ui_router_core_1.StateObject({ params: {}, resolvables: [] }));
        var node = new ui_router_core_1.PathNode(new ui_router_core_1.StateObject({ params: {}, resolvables: [] }));
        var context = new ui_router_core_1.ResolveContext([parentNode, node]);
        context.addResolvables(ui_router_core_1.resolvablesBuilder({ resolve: invocables }), node.state);
        var resolveData = function (parentLocals) {
            var rewrap = function (_locals) { return ui_router_core_1.resolvablesBuilder({ resolve: ui_router_core_1.mapObj(_locals, function (local) { return function () { return local; }; }) }); };
