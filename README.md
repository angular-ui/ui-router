...
**(2)** Check out the [roadmap](https://github.com/angular-ui/ui-router/wiki/Roadmap) to see where the project is headed, and if your feature idea fits with where we're headed.
