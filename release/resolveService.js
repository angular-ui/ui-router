...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ui-router-core'), require('angular')) :
    typeof define === 'function' && define.amd ? define(['exports', 'ui-router-core', 'angular'], factory) :
    (factory((global['angular-ui-router-resolve-service'] = global['angular-ui-router-resolve-service'] || {}),global['ui-router-core'],global.angular));
}(this, (function (exports,uiRouterCore,angular) { 'use strict';
...
var $resolve = {
    ...
    * ### Not bundled by default
    ...
    resolve: function (invocables, locals, parent) {
        ...
        var parentNode = new uiRouterCore.PathNode(new uiRouterCore.StateObject({ params: {}, resolvables: [] }));
        var node = new uiRouterCore.PathNode(new uiRouterCore.StateObject({ params: {}, resolvables: [] }));
        var context = new uiRouterCore.ResolveContext([parentNode, node]);
        context.addResolvables(uiRouterCore.resolvablesBuilder({ resolve: invocables }), node.state);
        var resolveData = function (parentLocals) {
            var rewrap = function (_locals) { return uiRouterCore.resolvablesBuilder({ resolve: uiRouterCore.mapObj(_locals, function (local) { return function () { return local; }; }) }); };
